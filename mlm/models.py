...
class ReferalCode(models.Model):
    created_by = models.ForeignKey(CandyUser, on_delete=models.CASCADE)
...
class CandyUserReferral(models.Model):
    parent = models.ForeignKey(
        CandyUser, editable=False, on_delete=models.CASCADE, blank=False, null=False, related_name='parent')
    referral_code = models.ForeignKey(
        ReferalCode, editable=False, on_delete=models.CASCADE, blank=False, null=False)
